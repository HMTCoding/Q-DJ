      ...
      try {
        ...
        if (data.item) {
          setCurrentTrack({
            id: data.item.id,
            name: data.item.name,
            artists: data.item.artists.map((artist: any) => ({ name: artist.name })),
            album: {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center">
        <div className="text-center p-8 bg-gray-800/50 rounded-xl border border-gray-700 max-w-md">
          ...
          <p className="text-gray-300 mb-6">Please log in to access the DJ dashboard</p>
          <a 
            href="/"
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 font-sans p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <header className="mb-10 text-center">
          ...
          <p className="text-xl text-gray-300">Manage your event: {event?.name || eventId}</p>
        </header>
        ...
        <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 backdrop-blur-sm mb-8">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center">
              <span className={`mr-2 ${isPolling ? 'text-green-500' : 'text-red-500'}`}>
                ●
              </span>
          ...
          {currentTrack ? (
            <div className="flex items-center p-4 bg-gray-700/30 rounded-lg border border-gray-600">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-xl font-semibold text-white truncate">{currentTrack.name}</h3>
            ...
            <div className="text-center py-12">
              <p className="text-gray-400 text-lg">No track is currently playing</p>
              <p className="text-gray-500 mt-2">Start playing music on your Spotify to see it here</p>
            </div>
          )}
        </div>
